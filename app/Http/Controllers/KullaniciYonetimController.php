    ...
    public function index()
    {
        ...
        return Inertia::render('Tanim/Kullanicilar', [
            ...
            'yetkiEtiketleri' => [
                ...
                'genel_raporlar' => 'Genel Raporlar (Özlük/Devam)',
                'hesap_raporlari' => 'Hesap Raporları (Tümü)',
                'hesap_puantaj' => 'Puantaj Hesaplama',
                'hesap_genel_maas' => 'Genel Bazda Maaş Ekstresi',
                'hesap_kisi_maas' => 'Kişi Bazında Maaş Ekstresi',
                'hesap_maas_pusulasi' => 'Maaş Pusulası',
                'hesap_grup_maas' => 'Grup Bazlı Maaş Ekstresi',
                ...
                'toplu_yemek' => 'Toplu Yemek Atama',
                'toplu_servis_yol' => 'Toplu Servis/Yol Parası',
