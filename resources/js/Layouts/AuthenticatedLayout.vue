...
const loadSections = () => {
    ...
    return { personel: true, toplu: false, tanim: false };
};
            ...
            <aside class="w-52 bg-white border-r border-gray-400 flex flex-col overflow-y-auto shadow-inner">
                ...
                <div v-if="y('toplu_islemler')" class="border-b border-gray-300">
                    ...
                    <div v-show="sections.toplu" class="bg-white">
                        ...
                        <Link v-if="y('toplu_agi')" :href="route('toplu-islemler.agi-atama')" class="sidebar-item" :class="{'sidebar-item-active': route().current('toplu-islemler.agi-atama')}">
