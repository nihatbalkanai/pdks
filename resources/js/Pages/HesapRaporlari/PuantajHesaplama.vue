...
const filtrelenmisPersoneller = computed(() => {
    ...
    const q = aramaText.value.toLowerCase();
                ...
                <div class="w-64 border-r border-gray-300 flex flex-col bg-gray-50">
                    ...
                    <div class="flex-1 overflow-y-auto">
                        <label v-for="p in filtrelenmisPersoneller" :key="p.id"
                            ...
                            <div class="min-w-0"><div class="font-medium text-gray-800 truncate">{{ p.ad }} {{ p.soyad }}</div><div class="text-[9px] text-gray-400">{{ p.sicil_no || '-' }}</div></div>
                        </label>
                    </div>
