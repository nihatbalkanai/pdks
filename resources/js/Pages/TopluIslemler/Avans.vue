...
<template>
<Head title="Toplu Avans Tanımları" />
<AuthenticatedLayout>
    <div class="p-4 h-full flex flex-col">
        <div class="bg-white border border-gray-400 shadow-md flex flex-col h-full">
            <div class="bg-gradient-to-r from-[#d8e4f8] to-[#c0d0e8] border-b border-gray-400 px-4 py-2">
                <h2 class="font-bold text-sm text-gray-800">Toplu Avans Tanımları</h2>
            </div>
            <div class="flex flex-1 overflow-hidden">
                ...
                <div class="flex-1 p-5 overflow-y-auto">
                    <div class="mb-5">
                        ...
                        <span class="ml-3 text-sm text-gray-600">Avans vermek istediğiniz personelleri seçin</span>
                    ...
                    <div class="mb-5 border-t border-gray-300 pt-4">
                        ...
                        <span class="ml-3 text-sm text-gray-600">Avans bilgilerini tanımlayınız</span>
