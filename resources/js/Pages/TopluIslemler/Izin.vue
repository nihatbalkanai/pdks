...
const submit = () => {
    ...
    form.post(route('toplu-islemler.izin.uygula'), {
        onSuccess: () => { clearInterval(iv); progress.value = 100; isProcessing.value = false; Swal.fire('Başarılı!', 'İzin kayıtları oluşturuldu.', 'success'); },
