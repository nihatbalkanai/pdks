...
const submit = () => {
    ...
    form.post(route('toplu-islemler.prim.uygula'), {
        onSuccess: () => { clearInterval(iv); progress.value = 100; isProcessing.value = false; Swal.fire('Başarılı!', `${selectedIds.value.length} personele prim tanımlandı.`, 'success'); },
