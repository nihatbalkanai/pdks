        ...
        <div class="bg-white border border-gray-400 shadow-md flex flex-col h-full overflow-hidden">
            ...
            <div class="flex flex-1 overflow-hidden">
                ...
                <div class="w-56 border-r border-gray-400 bg-gray-50 flex flex-col">
                    <div class="p-2 border-b border-gray-300"><input v-model="arama" type="text" placeholder="🔍 Ara..." class="w-full border-gray-300 rounded-sm py-1 px-2 text-xs focus:ring-green-400 focus:border-green-400"></div>
